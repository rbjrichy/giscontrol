...
@section('content_header')
    <div class="callout callout-info">
        @livewire('select-d-m-p', ['respuesta' => $respuesta, 'accion'=>'show'])
    ...
    <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
        <div class="card-tools">
            ...
            <a class="btn btn-info" href="{!! route('admin.encuesta.respuesta.editar', [$encuesta->id, $respuesta->id]) !!}" title="Ir a Editar Respuesta">
                Editar Respuesta
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header d-flex p-0">
            ...
            <ul class="nav nav-pills ml-auto p-2">
                <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Datos Predio</a></li>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    @include('encuestas.respuestas.respuesta')
                </div>
            </div>
